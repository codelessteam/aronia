...
Kirki::add_field( 'cl_aronia', array(
	'type'        => 'typography',
	'settings'    => 'body_typo',
	'label'       => esc_attr__( 'Body Typography', 'aronia' ),
	'tooltip'       => esc_attr__( 'For all screens', 'aronia' ),
...
Kirki::add_field( 'cl_aronia', array(
	'type'        => 'typography',
	'settings'    => 'h1_typo',
	'label'       => esc_attr__( 'H1 Typography', 'aronia' ),
	'tooltip'       => esc_attr__( 'For all screens', 'aronia' ),
	'section'     => 'cl_typography_general',
	'into_group' => true,
	'show_subsets' => false,
...
Kirki::add_field( 'cl_aronia', array(
	'type'        => 'typography',
	'settings'    => 'h2_typo',
	'label'       => esc_attr__( 'H2 Typography', 'aronia' ),
	'tooltip'       => esc_attr__( 'For all screens', 'aronia' ),
	'section'     => 'cl_typography_general',
	'into_group' => true,
	'show_subsets' => false,
...
Kirki::add_field( 'cl_aronia', array(
	'type'        => 'typography',
	'settings'    => 'h3_typo',
	'label'       => esc_attr__( 'H3 Typography', 'aronia' ),
	'tooltip'       => esc_attr__( 'For all screens', 'aronia' ),
	'section'     => 'cl_typography_general',
	'into_group' => true,
	'show_subsets' => false,
...
Kirki::add_field( 'cl_aronia', array(
	'type'        => 'typography',
	'settings'    => 'h4_typo',
	'label'       => esc_attr__( 'H4 Typography', 'aronia' ),
	'tooltip'       => esc_attr__( 'For all screens', 'aronia' ),
	'section'     => 'cl_typography_general',
	'into_group' => true,
	'show_subsets' => false,
...
Kirki::add_field( 'cl_aronia', array(
	'type'        => 'typography',
	'settings'    => 'h5_typo',
	'label'       => esc_attr__( 'H5 Typography', 'aronia' ),
	'tooltip'       => esc_attr__( 'For all screens', 'aronia' ),
	'section'     => 'cl_typography_general',
	'into_group' => true,
	'show_subsets' => false,
...
Kirki::add_field( 'cl_aronia', array(
	'type'        => 'typography',
	'settings'    => 'h6_typo',
	'label'       => esc_attr__( 'H6 Typography', 'aronia' ),
	'tooltip'       => esc_attr__( 'For all screens', 'aronia' ),
	'section'     => 'cl_typography_general',
	'into_group' => true,
	'show_subsets' => false,
...
Kirki::add_field( 'cl_aronia', array(
	...
	'label'       => esc_attr__( 'Sidebar Widgets Title', 'aronia' ),
	'section'     => 'cl_typography_general',
	'into_group' => true,
	'show_subsets' => false,
	'default'     => array(
