...
Kirki::add_field('cl_aronia', array(
	'type' => 'typography',
	'settings' => 'menu_font',
	'label' => esc_attr__('Menu Typography', 'aronia') ,
	'section' => 'cl_header_menu',
	'into_group' => true,
	'default' => array(
...
Kirki::add_field('cl_aronia', array(
	...
	'label' => esc_attr__('Submenu Title Typography', 'aronia'),
	'tooltip' => esc_attr__('Applied on megamenu title, submenu title and mobile', 'aronia'),
	'section' => 'cl_header_menu',
	'into_group' => true,
	'default' => array(
		'variant' => '400',
...
Kirki::add_field('cl_aronia', array(
	...
	'label' => esc_attr__('Submenu Items Typography', 'aronia') ,
	'tooltip' => esc_attr( 'All other items without Submenu, Except Main Navigation Items.', 'aronia' ),
	'section' => 'cl_header_menu',
	'into_group' => true,
	'default' => array(
		'font-size' => '14px',
...
Kirki::add_field('cl_aronia', array(
	...
	'label' => esc_attr__('Mobile Menu Hamburger Color', 'aronia') ,
	'section' => 'cl_header_menu',
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'    => esc_attr__( 'Menu Items Animation', 'aronia' ),
