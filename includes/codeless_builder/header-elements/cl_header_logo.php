    ...
    if( ! function_exists('codeless_header_logo_helper') ){
        function codeless_header_logo_helper(){
            ...
            if( codeless_get_mod('logo_type', 'font') == 'image' )
            {
                ...
                if(!empty($logo_url))
                    $logo = "<img class='cl-logo__img--dark cl-logo__img' src=\"".esc_url($logo_url)."\" alt='".esc_attr__('Main Logo', 'aronia')."' />";
                if( !empty( $logo_iphone ) )
                    $logo .= "<img class='cl-logo__img cl-logo__img--iphone' src=\"".esc_url($logo_iphone)."\" alt='".esc_attr__('IPhone Logo', 'aronia')."' />";
                if( !empty( $logo_ipad ) )
                    $logo .= "<img class='cl-logo__img cl-logo__img--ipad' src=\"".esc_url($logo_ipad)."\" alt='".esc_attr__('IPad Logo', 'aronia')."' />";

                if(!empty($logo_light_url))
                    $logo_light = "<img class='cl-logo__img cl-logo__img--light' src=\"".esc_url($logo_light_url)."\" alt='".esc_attr__('Light Logo', 'aronia')."' />";
            ...
            {   
                $logo = codeless_get_mod('logo_font_text', 'aronia');
