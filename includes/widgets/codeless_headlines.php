    ...
    function form($instance){
        ...
        <p>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id('type') ); ?>" name="<?php echo esc_attr( $this->get_field_name('type')); ?>" value="<?php echo esc_attr($type); ?>">
                <option value="popular" <?php echo codeless_complex_esc( ($type == 'popular' ? 'selected="selected"': '' ) )?>><?php esc_attr_e('Popular', 'aronia') ?></option>
                <option value="latest" <?php echo codeless_complex_esc( ($type == 'latest' ? 'selected="selected"': '' ) )?>><?php esc_attr_e('Latest', 'aronia') ?></option>
            </select>
            </label>
