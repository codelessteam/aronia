 ...
 * @since 1.1.0
 */
class codeless_latest_posts extends Widget_Base {
	...
	private function wpcap_content_layout_options() {
		...
		$this->start_controls_section(
			'section_layout',
			[
				'label' => esc_html__( 'Layout', 'aronia' ),
			]
		);
		...
		$this->add_control(
			'grid_style',
			[
				'label' => __( 'Grid Style', 'aronia' ),
				'type' => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [
					'1' => esc_html__( 'Layout 1', 'aronia' ),
					'2' => esc_html__( 'Layout 2', 'aronia' ),
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' => __( 'Posts Per Page', 'aronia' ),
		...
		$this->add_control(
			'show_image',
			[
				'label' => __( 'Image', 'aronia' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'aronia' ),
				'label_off' => __( 'Hide', 'aronia' ),
				'default' => 'yes',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'title_tag',
			[
				'label' => __( 'Title HTML Tag', 'aronia' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->add_control(
			'meta_data',
			[
				'label' => __( 'Meta Data', 'aronia' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT2,
				'default' => [ 'date', 'comments' ],
				'multiple' => true,
				'options' => [
					'author' => __( 'Author', 'aronia' ),
					'date' => __( 'Date', 'aronia' ),
					'categories' => __( 'Categories', 'aronia' ),
					'comments' => __( 'Comments', 'aronia' ),
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'meta_separator',
			[
				'label' => __( 'Separator Between', 'aronia' ),
		...
		$this->add_control(
			'excerpt_length',
			[
				'label' => __( 'Excerpt Length', 'aronia' ),
				'type' => Controls_Manager::NUMBER,
		...
		$this->add_control(
			'read_more_text',
			[
				'label' => __( 'Read More Text', 'aronia' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More', 'aronia' ),
				'condition' => [
					'show_read_more' => 'yes',
				],
			]
		...
		$this->add_control(
			'content_align',
			[
				'label' => __( 'Alignment', 'aronia' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'aronia' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'aronia' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => __( 'Right', 'aronia' ),
	...
	private function wpcap_content_query_options() {
		...
		$this->add_control(
			'orderby',
			[
				'label' => __( 'Order By', 'aronia' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_date',
				'options' => [
					'post_date' => __( 'Date', 'aronia' ),
					'post_title' => __( 'Title', 'aronia' ),
					'rand' => __( 'Random', 'aronia' ),
				],
			]
		);
	...
	private function wpcap_style_layout_options() {
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Columns margin', 'aronia' ),
	...
	protected function render_meta() {
		...
		<div class="post-grid-meta">
			...
			if ( in_array( 'categories', $meta_data ) ) {
				...
				$categories_list = get_the_category_list( esc_html__( ', ', 'aronia' ) ); 
