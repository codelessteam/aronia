				...
				<div class="comment-content post-content" itemprop="text">
					...
					<div class="comment-meta post-meta" role="complementary">
						<div class="comment-author">
							<a class="comment-author-link h6" href="<?php comment_author_url(); ?>" itemprop="author"><?php comment_author(); ?></a>
							<span class="comment-author-says"><?php esc_attr_e( 'says:', 'aronia' ) ?></span>
							<?php comment_reply_link(array_merge( $args, array('reply_text' => '<span>'.esc_html__('Reply', 'aronia' ).'</span>', 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
							<?php edit_comment_link( esc_html__('Edit this comment','aronia' ),'',''); ?>
						</div>
