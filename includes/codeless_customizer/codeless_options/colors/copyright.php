...
Kirki::add_section('cl_colors_copyright', array(
	'title' => esc_attr__('Copyright Colors', 'aronia') ,
	'tooltip' => '',
	'panel' => 'cl_colors',
	'type' => '',
	'priority' => 8,
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'       => esc_attr__( 'Link Color', 'aronia' ),
    'section'     => 'cl_colors_copyright',
    'into_group' => true,
    'inline_control' => true,
    'default'     => '#363b43',
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'       => esc_attr__( 'Link Hover Color', 'aronia' ),
    'section'     => 'cl_colors_copyright',
    'into_group' => true,
    'inline_control' => true,
    'default'     => '#e94828',
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'       => esc_attr__( 'Borders Color', 'aronia' ),
    'section'     => 'cl_colors_copyright',
    'into_group' => true,
    'inline_control' => true,
    'default'     => '#edeeef',
