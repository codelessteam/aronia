    ...
    static function get_demos(){
        $demos = array(
            ...
            array(
                'id' => 'default',
                'label' => '',
                'preview' => 'http://codeless.co/aronia/default',
                'parts' => 1,
                'home_slug' => 'home',
                'header' => 'main',
                'footer' => 'main'
            ...
            array(
                'id' => 'business',
                'label' => 'business',
                'preview' => 'http://codeless.co/aronia/business',
                'parts' => 1,
                'home_slug' => 'home',
                'header' => 'main',
                'footer' => 'main'
               ...
               array(
                'id' => 'startup',
                'label' => 'startup',
                'preview' => 'http://codeless.co/aronia/startup',
                'parts' => 1,
                'home_slug' => 'home',
                'header' => 'main',
                'footer' => 'main'
    ...
    static function get_headers(){
        $demos = array(
            array(
                'id' => 'main',
                'label' => 'Blog 1',
                'preview' => 'http://codeless.co/aronia/blog'
            ),
            array(
                'id' => 'magazine',
                'label' => 'Magazine Main',
                'preview' => 'http://codeless.co/aronia/magazine'
            ),
            array(
                'id' => 'main2',
                'label' => 'Main 2',
            ...
            array(
                ...
                'preview' => 'https://codeless.co/aronia/blog/?page_id=2666'
            ),

            array(
                'id' => 'blog8',
                'label' => 'Blog 8',
                'preview' => 'https://codeless.co/aronia/blog/'
            ),

            array(
                'id' => 'dark',
                'label' => 'Dark',
                'preview' => 'https://codeless.co/aronia/blog/?page_id=2680'
            ),

            array(
                'id' => 'logo_center',
                'label' => 'Logo in Center',
                'preview' => 'https://codeless.co/aronia/blog/?page_id=2692'
            ),

            array(
                'id' => 'logo_center_2',
                'label' => 'Logo in Center 2',
                'preview' => 'https://codeless.co/aronia/blog/?page_id=2709'
            ),
            array(
                'id' => 'magazine2',
    ...
    static function get_footers(){
        $demos = array(
            ...
            array(
                'id' => 'dark',
                'label' => 'Blog Dark',
                'preview' => 'http://codeless.co/aronia/blog/?page_id=2680'
            ),
