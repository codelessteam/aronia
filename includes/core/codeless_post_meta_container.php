...
class Cl_Post_Meta{
    ...
    public static function register_meta_boxes_inpage( $meta_boxes ) {
        ...
        $meta_boxes[] = array(
            'id'         => 'layout_sect',
            'title'      => esc_html__( 'Layout', 'aronia' ),
        ...
        $meta_boxes[] = array(
            'id'         => 'general',
            'title'      => esc_html__( 'General', 'aronia' ),
        ...
        $meta_boxes[] = array(
            'id'         => 'post_data',
            'title'      => esc_html__( 'Post Data', 'aronia' ),
        ...
        $meta_boxes[] = array(
            'id'         => 'slider_layout',
            'title'      => esc_html__( 'Style & Layout', 'aronia' ),
        ...
        $meta_boxes[] = array(
            'id'         => 'slider_query',
            'title'      => esc_html__( 'Slider Query', 'aronia' ),
            'post_types' => array('codeless_slider'),
            'priority'   => 'high',
        ...
        $meta_boxes[] = array(
            'id'         => 'portfolio_data',
            'title'      => esc_html__( 'Portfolio Data', 'aronia' ),
