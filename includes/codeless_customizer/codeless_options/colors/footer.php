...
Kirki::add_section('cl_colors_footer', array(
	'title' => esc_attr__('Footer Colors', 'aronia') ,
	'tooltip' => '',
	'panel' => 'cl_colors',
	'type' => '',
	'priority' => 8,
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'       => esc_attr__( 'Widget Title Color', 'aronia' ),
    'section'     => 'cl_colors_footer',
    'into_group' => true,
    'inline_control' => true,
    'default'     => '#191e23',
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'       => esc_attr__( 'Text Color', 'aronia' ),
    'section'     => 'cl_colors_footer',
    'into_group' => true,
    'inline_control' => true,
    'default'     => '#363b43',
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'       => esc_attr__( 'Links Color', 'aronia' ),
    'section'     => 'cl_colors_footer',
    'into_group' => true,
    'inline_control' => true,
    'default'     => '#363b43',
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'       => esc_attr__( 'Links Hover Color', 'aronia' ),
    'section'     => 'cl_colors_footer',
    'into_group' => true,
    'inline_control' => true,
    'default'     => '#e94828',
...
Kirki::add_field( 'cl_aronia', array(
    ...
    'label'       => esc_attr__( 'Inner Borders Color', 'aronia' ),
    'section'     => 'cl_colors_footer',
    'into_group' => true,
    'inline_control' => true,
    'default'     => '#edeeef',
